    ...
    <main class="p-6 bg-gray-50 overflow-auto">
        <div>
            ...
            <div class="flex justify-between items-center flex-wrap-reverse gap-2 mb-4 font-serif">
                ...
                <button onclick="window.location.href='/admin/create-produk'"
        ...
        <div class="overflow-x-auto bg-white  rounded-lg shadow font-serif">
            <table class="w-full border border-gray-200">
                ...
                <tbody>
                    <tr>
                        <td class="border-gray-300 border-b px-4 py-2 text-center">1</td>
                        <td class="border-gray-300 border-b px-4 py-2">Bahan Kebaya Solo</td>
                        <td class="border-gray-300 border-b px-4 py-2 text-center">6</td>
                        <td
                            class="border-gray-300 border-b px-4 py-2 text-center flex items-center justify-center gap-2">
                            {{-- Button Hapus --}}
                            <div x-data="{ open: false }" x-cloak class="relative">
                                
                                <button @click="open = true" class="text-red-500 hover:text-red-700"><svg xmlns="http://www.w3.org/2000/svg"
                                ...
                                <div x-show="open" x-transition:enter="transition ease-out duration-300"
                                    ...
                                    <div x-show="open" x-transition:enter="transition ease-out duration-300"
                                        ...
                                        <p class="text-gray-600 mb-6">Anda Yakin Hapus Produk</p>
                            ...
                            {{-- Button Edit --}}
                            <button onclick="window.location.href='/admin/update-produk'"
                                class="text-blue-500 hover:text-blue-700 mt-1"><svg xmlns="http://www.w3.org/2000/svg"
                                    fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                    class="w-6 h-6 text-blue-500 hover:text-blue-700 cursor-pointer">
                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        d="M16.862 4.487l1.687-1.688a1.875 1.875 0 112.652 2.652L10.582 16.07a4.5 4.5 0 01-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 011.13-1.897l8.932-8.931z" />
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M19.5 7.125l-1.875-1.875" />
                                </svg>
                            </button>
                        </td>
                    </tr>
