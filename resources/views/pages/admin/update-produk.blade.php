<x-layouts.admin>
    <main class="p-6 bg-gray-50 overflow-auto" x-data="uploadBukti()">
        <div class="border-b border-gray-300 mb-5">
            <h2 class="text-2xl font-bold mb-4">Update Produk</h2>
        </div>
        ...
        <form action="/products" method="POST" class="space-y-4 font-serif">
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-2 md:gap-4">
                ...
                <input type="text" id="name" name="name" value="Batik Jogja"
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-2 md:gap-4">
                ...
                <input type="text" id="category" name="category" value="Batik"
                    class="md:col-span-3 border border-gray-300 rounded px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-2 md:gap-4">
                ...
                <input type="text" id="size" name="size" value="1 m"
                    class="md:col-span-3 border border-gray-300 rounded px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-2 md:gap-4">
                ...
                <input type="text" id="teknik" name="teknik" value="Printing"
                    class="md:col-span-3 border border-gray-300 rounded px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-2 md:gap-4">
                ...
                <input type="text" id="material" name="material" value="Kain"
                    class="md:col-span-3 border border-gray-300 rounded px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400">
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 items-center gap-2 md:gap-4">
                ...
                <input type="text" id="price" name="price" value="Rp. 200.000"
                    class="md:col-span-3 border border-gray-300 rounded px-3 py-2 w-full focus:outline-none focus:ring-2 focus:ring-green-400 focus:border-green-400">
            </div>
