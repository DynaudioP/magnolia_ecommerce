...
<body>
    ...
    <div class="flex flex-col lg:flex-row min-h-screen bg-gray-100">
        ...
        <div class="flex flex-col justify-center items-center w-full lg:w-1/2 p-6 gap-5">
            ...
            <div class="bg-white rounded-xl border border-gray-200 px-6 lg:px-12 py-14 w-full max-w-md shadow">
                <div>
                    <h4 class="text-xl font-bold">LOGIN</h4>
                    <h6 class="text-sm">
                        Tidak memiliki akun?
                        <a href="/register" class="text-[#36A4A9] font-medium hover:underline">Daftar</a>
                    </h6>
                </div>

                <!-- Form -->
                <form action="{{route('admin.loginController')}}" method="POST" class="flex flex-col gap-5 mt-6">
                    @csrf
                    {{-- Validation Errors --}}
                        @if ($errors->any()) 
